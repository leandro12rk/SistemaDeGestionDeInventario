...
VALUES ('Laptops', 'Equipos portátiles para oficina y gaming'),
...
VALUES ('Intcomex Panamá', 'Ricardo Pérez', 'ventas@intcomex.com.pa', '+507 300-1234', 'Costa del Este'),
...
SELECT (ARRAY['MacBook Air M2', 'Dell XPS 13', 'Monitor LG 27"', 'SSD Samsung 980 Pro', 'Teclado Logitech G Pro',
        'Router TP-Link Archer', 'Impresora Epson L3210', 'RAM Corsair 16GB', 'Procesador Ryzen 7',
        'Mouse Razer Deathadder'])[floor(random() * 10) + 1] || ' - v' || i,
